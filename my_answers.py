...
class NeuralNetwork(object):
    def __init__(self, input_nodes, hidden_nodes, output_nodes, learning_rate):
        ...
        #### sigmoid function ####
        # Lambda expression with sigmoid function
        
        self.activation_function = lambda x : 1 / (1 + np.exp(-x))  # sigmoid calculation.
        
        ### alternative sigmoid fuction ###
        #
        #def sigmoid(x):
        #    return  1 / (1 + np.exp(-x))
    ...
    def train(self, features, targets):
        ...
        for X, y in zip(features, targets):
            ...
            final_outputs, hidden_outputs = self.forward_pass_train(X)  #forward pass function below
            #the backproagation function below
